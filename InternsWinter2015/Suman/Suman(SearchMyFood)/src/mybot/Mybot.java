...
//please read documentation for implementation method
...
public class Mybot{
	...
	// The android app associated with it needs to create multiple databases in server
	...
	// to register the student and his institute.
	@OnKeyword("start")
