...
public class MeetupClient
{
	...
	static private final String MEETUP_ENDPOINT_URL = "http://api.meetup.com/2/";
	...
	static private final String FORMAT = "json";
	...
	protected Response sendApiRequest(java.util.Map<String, String> params, String extraPath)
	{
		...
		if (extraPath.startsWith("/open_events"))
		{
			clazz = Event.class;
		}
	...
	protected String sendApiRequestAkshit(java.util.Map<String, String> params, String extraPath)
	{
	...
	public List<Event> getEvents(EventSearchCriteria crit)
	{
		...
		Response r = sendApiRequest(crit.getParameterMap(), "/open_events." + FORMAT);
		
		return r.getEvents();
	}
	
	public String getEventsAkshit(EventSearchCriteria crit)
	{
		
		String r = sendApiRequestAkshit(crit.getParameterMap(), "/open_events." + FORMAT);
