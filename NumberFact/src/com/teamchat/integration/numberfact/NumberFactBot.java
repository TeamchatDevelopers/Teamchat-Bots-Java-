...
public class NumberFactBot
{
	...
	public void help(TeamchatAPI api)
	{
		...
		api.perform(api.context().currentRoom().post(new PrimaryChatlet().setQuestionHtml(Utility.help).setReplyScreen(f).setReplyLabel("Enter").alias("getfact")));
	...
	public void getFact(TeamchatAPI api) throws Exception
	{
		...
		if (fact.equals("Trivia"))
		{
			...
			api.perform(api.context().currentRoom().post(new PrimaryChatlet().setQuestionHtml("Enter integer of interest").setReplyScreen(f).setReplyLabel("Enter").alias("triviafact")));
		}
		...
		if (fact.equals("Year"))
		{
			...
			api.perform(api.context().currentRoom().post(new PrimaryChatlet().setQuestionHtml("Enter year of interest").setReplyScreen(f).setReplyLabel("Enter").alias("yearfact")));
		}
	}
	...
	public void dateFact(TeamchatAPI api) throws Exception
	{
		...
		if (responseCode == 200)
		{
			...
			api.perform(api.context().currentRoom().post(new PrimaryChatlet().setQuestionHtml("<center><img src='http://integration.teamchat.com/sol/bot-images/numbers.jpg' width='150' /></center>"
					+ "<div><p style='padding-left:5px; padding-right:5px;align:center; margin-top:5px'><b>Fact: </b>" + fact + "<br/><br/><b>Date: </b>" + day + "-" + month + "-" +year +  "</p></div>")));
		}
		else
		{
			api.perform(api.context().currentRoom().post(new PrimaryChatlet().setQuestionHtml("<center><img src='http://integration.teamchat.com/sol/bot-images/numbers.jpg' width='150' /></center>"
	...
	public void numberFact(TeamchatAPI api) throws Exception
	{
		...
		if (responseCode == 200)
		{
			...
			api.perform(api.context().currentRoom().post(new PrimaryChatlet().setQuestionHtml("<center><img src='http://integration.teamchat.com/sol/bot-images/numbers.jpg' width='150' /></center>"
					+ "<div><p style='padding-left:5px; padding-right:5px;align:center; margin-top:5px'><b>Number: </b>" + number + "<br/><br/><b>Fact: </b>" + response +  "</p></div>")));
		}
		else
		{
			api.perform(api.context().currentRoom().post(new PrimaryChatlet().setQuestionHtml("<center><img src='http://integration.teamchat.com/sol/bot-images/numbers.jpg' width='150' /></center>"
	...
	public void yearFact(TeamchatAPI api) throws Exception
	{
		...
		if (responseCode == 200)
		{
			...
			api.perform(api.context().currentRoom().post(new PrimaryChatlet().setQuestionHtml("<center><img src='http://integration.teamchat.com/sol/bot-images/numbers.jpg' width='150' /></center>"
					+ "<div><p style='padding-left:5px; padding-right:5px;align:center; margin-top:5px'><b>Year: </b>" + year + "<br/><br/><b>Fact: </b>" + response +  "</p></div>")));
		}
		else
		{
			api.perform(api.context().currentRoom().post(new PrimaryChatlet().setQuestionHtml("<center><img src='http://integration.teamchat.com/sol/bot-images/numbers.jpg' width='150' /></center>"
