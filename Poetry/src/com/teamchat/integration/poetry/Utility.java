...
{	
	...
	public static final String help = image + "<h3 style='color:#159ceb'>Hi, I am the Poetry Bot</h3><div></div><div><p>I can fetch any famous poetry for you. To search for a poetry, select an author and then choose the poem.</p></div><div>You can also use the keyword <b>poetry</b> to search for poetries</div>";
	...
	public static final String sorry = image + "<div><p style='padding-left:5px; padding-right:5px;align:center; margin-top:5px'>Sorry! no results.</p></div>";
